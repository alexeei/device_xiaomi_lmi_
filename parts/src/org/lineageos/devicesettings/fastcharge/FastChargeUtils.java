...
package org.lineageos.devicesettings.fastcharge;
...
public class FastChargeUtils {
    ...
    // Charging modes
    public static final int MODE_3 = 3000000;
    public static final int MODE_2 = 2000000;
    public static final int MODE_1 = 1000000;
    ...
    public int getNormalFastChargeMode() {
        try {
            ...
            return value != null ? Integer.parseInt(value) : MODE_1;
        } catch (Exception e) {
    ...
    public void enableThermalBoost(boolean enable) {
        try {
            FileUtils.writeLine(THERMAL_BOOST_NODE, enable ? "0" : "1");
